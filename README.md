...
| ForgeDeployment | Deploy applications to cloud providers with automated provisioning | 2.4.0 | MIT | Forge Team |
| ForgeErrorHandler | An error handler by Forge | 1.2.0 | MIT | Forge Team |
| ForgeEvents | An Event Queue system by forge | 1.3.0 | MIT | Forge Team |
| ForgeHub | Administration Hub for Forge Framework | 2.3.0 | MIT | Forge Team |
