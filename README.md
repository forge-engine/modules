...
|--------|-------------|---------|---------|--------|
| ForgeAuth | An Auth module by forge. | 0.6.0 | MIT | Forge Team |
...
| ForgeEvents | An Event Queue system by forge | 1.1.0 | MIT | Forge Team |
...
| ForgeWire | A reactive controller rendering protocol for PHP | 2.5.1 | MIT | Forge Team |
