...
class DebugBar implements DebugBarInterface
{
    ...
    {
        $modulePath = Path::modulePath('DebugBar', 'views/debugbar.php');
        ob_start();
    ...
    {
        $cssLinkTag = sprintf('<link rel="stylesheet" href="%s">', Path::moduleAsset('debugbar', 'debugbar.css'));
        $jsScriptTag = sprintf('<script src="%s"></script>', Path::moduleAsset('debugbar', 'debugbar.js'));
